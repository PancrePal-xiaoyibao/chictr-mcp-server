...
- [x] 14.3 请求延迟优化
  ...
  - 减少触发验证码概率
- [x] 14.4 代理支持
  - HTTP_PROXY/HTTPS_PROXY 环境变量支持
- [x] 14.5 Headless 模式适配
  - 支持 npx 远程执行
  - 服务器环境兼容

## 阶段 15: 多维度搜索 (v1.2.0+)
- [x] 15.1 按注册号搜索
  - 添加 registration_number 参数
  - 对应 URL 的 regno 字段
- [x] 15.2 按年份搜索
  - 添加 year 参数
  - 默认当前年份
  - 对应 URL 的 createyear 字段
- [x] 15.3 参数灵活化
  - 所有搜索参数改为可选
  - 移除 months 参数
- [x] 15.4 项目ID缓存机制
  - 搜索结果包含 project_id
  - 缓存注册号→项目ID 映射
  - 详情查询使用缓存的 project_id
- [x] 15.5 修复详情查询 400 错误
  - 使用正确的 project_id 构建 URL
  - 修复 URL 参数错误
